...
export const produceCategories = [
  ...
  { id: 'fertilizer', name: 'Fertilizers', icon: Bird },
  { id: 'tool', name: 'Tools', icon: Spade },
];
...
export const simFarmGames: Game[] = [
  ...
  },
  {
    ...
    levels: [
      ...
      },
      {
        ...
        choices: [
          ...
          },
          {
            ...
            isCorrect: false,
            feedback:
              "It's a bit early for root crops. They prefer less fertile soil, as too much nitrogen can cause them to grow hairy roots and small tops.",
            action: 'fail_choice',
          },
        ],
      },
      {
        ...
        description:
          "The heavy-feeding tomatoes are done. The soil's fertility is at its lowest point in the cycle. What's the ideal crop now?",
        choices: [
          {
            text: 'Root Crops (Carrots, Potatoes) - they can scavenge for nutrients and help break up compacted soil.',
            isCorrect: true,
            feedback:
              'Exactly! Root crops finish the cycle. After this, you will plant a cover crop or return to legumes to restart the cycle.',
            action: 'plant_seeds',
          },
          {
            text: "More Heavy Feeders (Corn) - let's push the soil to its limit.",
            isCorrect: false,
            feedback:
              'Your crop will be stunted and unhealthy. The soil is exhausted and needs to be replenished, not pushed further.',
            action: 'set_health:-40',
          },
        ],
      },
      {
        ...
        description:
          'You have successfully completed a 4-year rotation, improving soil health and preventing pest buildup without chemicals.',
        choices: [
          {
            text: 'Plan the next 4-year cycle, starting with legumes again.',
            isCorrect: true,
            feedback:
              "You've mastered crop rotation! This sustainable practice is key to long-term organic farming success.",
            action: 'harvest',
          },
        ],
      },
  ...
  },
  {
    ...
    description:
      'Learn and apply sustainable, non-chemical techniques to manage weeds on your farm.',
    levels: [
      {
        level: 1,
        title: 'Pre-Emergent Strategy',
        description:
          'You are preparing a bed for planting carrots. You know it has a high weed seed bank. How do you get a head start on the weeds?',
        choices: [
          {
            text: 'Use the "stale seed bed" technique: water the bed, let weeds sprout, then kill them with shallow hoeing before planting carrots.',
            isCorrect: true,
            feedback:
              "A brilliant pro-level technique! You've tricked the first flush of weeds into showing themselves and eliminated them without deep tilling.",
            action: 'set_weeds:false',
          },
          {
            text: 'Cover the bed with a thick black tarp for several weeks before planting.',
            isCorrect: true,
            feedback:
              'Also an excellent choice! Solarization (or occultation) heats the soil, killing weed seeds and pathogens near the surface.',
            action: 'set_weeds:false',
          },
          {
            text: 'Till the bed deeply to bury the weed seeds.',
            isCorrect: false,
            feedback:
              "This is counter-productive. Tilling brings a new batch of dormant weed seeds to the surface, ready to germinate alongside your carrots.",
            action: 'till_soil;set_weeds:true',
          },
        ],
      },
      {
        ...
        title: 'Mulching',
        description:
          'Your crops are established, but weeds are starting to pop up between the rows. What is your primary tool?',
        choices: [
          {
            text: 'Apply a thick layer of straw or wood chip mulch.',
            isCorrect: true,
            feedback:
              'The best defense! Mulch blocks sunlight from reaching weed seeds, preventing them from germinating. It also conserves water and builds soil.',
            action: 'mulch:true',
          },
          {
            text: 'Spray the whole area with vinegar (acetic acid).',
            isCorrect: false,
            feedback:
              'Vinegar is a non-selective herbicide and will burn your crops just as effectively as the weeds. It also does nothing to improve the soil.',
            action: 'fail_game',
          },
        ],
      },
      {
        ...
        description:
          'Some persistent weeds are poking through your mulch. Which tool is best for removing them with minimal soil disturbance?',
        choices: [
          {
            text: 'A stirrup hoe (hula hoe), which you slide just under the soil surface to cut weeds at the root.',
            isCorrect: true,
            feedback:
              'The perfect tool! It slices off weeds without bringing new seeds to the surface, preserving your soil structure.',
            action: 'set_weeds:false',
          },
          {
            text: 'A large garden hoe, chopping deeply into the soil.',
            isCorrect: false,
            feedback:
              "This is too aggressive. The deep chopping action is basically tilling, and you'll just germinate more weeds.",
            action: 'set_weeds:true',
          },
          {
            text: 'A propane flame weeder.',
            isCorrect: false,
            feedback:
              "This is a great tool for pre-emergent weeding, but using it this close to your established crops is risky. You could easily scorch your plants.",
            action: 'set_health:-15',
          },
        ],
      },
      {
        ...
        title: 'Living Mulch',
        description:
          'In your orchard, grass and weeds are constantly growing around the base of your fruit trees.',
        choices: [
          {
            text: 'Plant a beneficial groundcover like clover or comfrey around the trees.',
            isCorrect: true,
            feedback:
              "Excellent! You're using a \"living mulch\" to out-compete undesirable weeds. The clover adds nitrogen, and comfrey mines for deep nutrients.",
            action: 'plant_cover_crop',
          },
          {
            text: 'Spray herbicide around each tree every month.',
            isCorrect: false,
            feedback:
              'This creates a cycle of dependency on chemicals, harms soil life, and risks damaging your trees\' shallow roots.',
            action: 'use_chemicals',
          },
        ],
      },
      {
        ...
        description:
          'Your integrated approach has worked. Your fields are clean, your soil is covered, and your crops are thriving without competition.',
        choices: [
          {
            text: 'Enjoy the harvest, knowing you beat the weeds sustainably.',
            isCorrect: true,
            feedback:
              "Congratulations! You've demonstrated a deep understanding of weed control that works with nature, not against it.",
            action: 'harvest',
          },
        ],
      },
  ...
  },
  {
    ...
    description:
      "Turn your farm's \"waste\" into a valuable soil amendment. Master the art of composting.",
    levels: [
      {
        level: 1,
        title: 'Building the Pile',
        description:
          'You have a pile of "green" materials (kitchen scraps, fresh grass clippings) and a pile of "brown" materials (dry leaves, straw). How do you start your compost pile?',
        choices: [
          {
            text: 'Layer the greens and browns like a lasagna, aiming for a 2:1 ratio of browns to greens by volume.',
            isCorrect: true,
            feedback:
              'The perfect recipe! This Carbon-to-Nitrogen ratio provides the ideal diet for the microbes that will break down the materials.',
            action: 'add_compost',
          },
          {
            text: 'Put all the greens in first, then pile the browns on top.',
            isCorrect: false,
            feedback:
              'This will create problems. The large layer of greens will become a dense, slimy, anaerobic mess, and the browns will take forever to decompose.',
            action: 'fail_choice',
          },
          {
            text: 'Mix it all together randomly.',
            isCorrect: false,
            feedback:
              'Better than the wrong layers, but not ideal. Layering ensures good air and moisture distribution throughout the pile.',
            action: 'fail_choice',
          },
        ],
      },
      {
        ...
        description:
          'Your pile has been sitting for a week. You squeeze a handful of the material and no water comes out, and it feels dry and crumbly.',
        choices: [
          {
            text: 'Add water. The pile should be as damp as a wrung-out sponge.',
            isCorrect: true,
            feedback:
              'Correct! Microbes need water to live and work. A dry pile will stop decomposing.',
            action: 'set_water:30',
          },
          {
            text: 'Do nothing. It needs to be dry.',
            isCorrect: false,
            feedback:
              'The decomposition process has stalled due to lack of moisture. The pile will just sit there.',
            action: 'fail_choice',
          },
        ],
      },
      {
        ...
        description:
          "The center of your pile is getting hot, which is good! But it's starting to smell like ammonia.",
        choices: [
          {
            text: "Turn the pile with a pitchfork, moving the outer layers to the inside and vice versa. This introduces oxygen.",
            isCorrect: true,
            feedback:
              "Exactly! The ammonia smell is a sign of anaerobic conditions. Turning the pile provides the oxygen the good microbes need and distributes heat and moisture.",
            action: 'set_health:10',
          },
          {
            text: 'Cover the pile with a tarp to trap the smell.',
            isCorrect: false,
            feedback:
              "This will make it worse! You're trapping the gasses and starving the pile of oxygen, encouraging the \"bad\" anaerobic microbes.",
            action: 'fail_choice',
          },
        ],
      },
      {
        ...
        description:
          'After several weeks, your pile has shrunk. How do you know the compost is finished and ready to use?',
        choices: [
          {
            text: 'It is dark, crumbly, and smells like rich earth. You can no longer identify the original ingredients.',
            isCorrect: true,
            feedback:
              "That's the sign of beautiful, finished compost! It's ready to be added to your garden beds.",
            action: 'set_growth:4',
          },
          {
            text: 'It is still warm in the center and you can see intact banana peels.',
            isCorrect: false,
            feedback:
              "Not yet. If it's still hot and you can see the original materials, the decomposition process is still active. Using it now can \"rob\" nitrogen from your soil.",
            action: 'fail_choice',
          },
        ],
      },
      {
        ...
        description:
          "You have created nutrient-rich compost from your farm's waste products, which you can now use to grow healthy food.",
        choices: [
          {
            text: 'Spread the finished compost on your fields.',
            isCorrect: true,
            feedback:
              'Congratulations! You have successfully closed the loop, turning waste into a valuable resource that builds soil fertility and resilience.',
            action: 'harvest',
          },
        ],
      },
